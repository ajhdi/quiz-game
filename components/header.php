  ...
  <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-8 animate-fade-in scale-95
    ...
    <form action="backend/user_profile_update.php" method="POST" class="space-y-5">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <input type="text" name="studNo" placeholder="Student Number" value="<?= htmlspecialchars($studentData['studNo']) ?>" class="w-full border-b-2 border-black focus:border-yellow-500 focus:outline-none px-2 py-2 bg-transparent placeholder-gray-400 transition" required>
