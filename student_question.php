        ...
        <div class="game-card">
            ...
            <div class="game-content">
                ...
                <div class="answers-container">
                    <button class="answer bg-yellow-200 hover:bg-yellow-300" data-id="1"></button>
                    <button class="answer bg-yellow-200 hover:bg-yellow-300" data-id="2"></button>
                    <button class="answer bg-yellow-200 hover:bg-yellow-300" data-id="3"></button>
                    <button class="answer bg-yellow-200 hover:bg-yellow-300" data-id="4"></button>
                </div>
...
<script>
    ...
    function showModal(score, total) {
        ...
        if (confirmBtn) {
            ...
            // confirmBtn.nextElementSibling.innerText = 'Close';
        }
    ...
    function hideModal() {
        ...
        window.location.href = 'student_dashboard.php'; // 👈 Redirect here
    }
    ...
    function updateTimer() {
        ...
        if (timeLeft > 60) {
            ...
            timeElem.innerText = `${minutes} minute${minutes > 1 ? 's' : ''} ${seconds} second${seconds !== 1 ? 's' : ''}`;
        } else {
            timeElem.innerText = `${timeLeft} second${timeLeft !== 1 ? 's' : ''}`;
        }
    ...
    function checkAnswer(selectedIndex) {
        ...
        console.log("Selected:", selectedIndex, "| Correct:", questionData.answer); // ← Add this line
    ...
    function endGame() {
        ...
        saveScore(score, shuffledQuestions.length); // 👈 Call the function
